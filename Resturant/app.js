...
header.addEventListener("click", showAll);
all.addEventListener("click", showAll);
starters.addEventListener("click", showStarters);
mains.addEventListener("click", showMains);
desserts.addEventListener("click", showDesserts);
beverages.addEventListener("click", showBeverages);
searchBar.addEventListener("input", searchBasedRendering);
navbarToggler.addEventListener("click", navbarTogglerFn);

function showAll() {
  const content = menu.map((item) => {
    return `<div class="menu-item col-12 col-md-6 col-lg-4">
              <div class="card h-100">
                <img src="${item.img}" class="card-img-top img-fluid" alt="${item.title}" style="object-fit: cover; height: 300px;">
                <div class="card-body">
